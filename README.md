...
|  2 | Section_Num    | Section number in the chapter (I don't recommend using this one as it's highly subjective, e.g., if the book moves from one section to another but the perspective remained the same, sometimes I kept it as part of the last section and sometimes I changed it). |
|  3 | Character_Name | Character whose perspective it is                                                                                                                                                                                                                                  |
|  4 | words          | Number of words in that section                                                                                                                                                                                                                                    |
|  5 | Affiliation    | Affiliation of that character (legions, sub-sections of the Imperium, etc.)                                                                                                                                                                                        |
|  6 | Title          | Character's title                                                                                                                                                                                                                                                  |
|  7 | Type           | Additional information about that character (e.g., psyker, greater daemon, Alpha Legion operative, etc.)                                                                                                                                                           |
|  8 | Species        | What 'species' that character is -- not hard and fast, but enough to distinguish Astartes from humans from Eldar.                                                                                                                                                  |
